...
_POSE = _descriptor.Descriptor(
  name='Pose',
  full_name='mvsim_msgs.Pose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='mvsim_msgs.Pose.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='mvsim_msgs.Pose.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='z', full_name='mvsim_msgs.Pose.z', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='yaw', full_name='mvsim_msgs.Pose.yaw', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pitch', full_name='mvsim_msgs.Pose.pitch', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='roll', full_name='mvsim_msgs.Pose.roll', index=5,
