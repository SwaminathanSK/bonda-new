...
_LISTTOPICSREQUEST = _descriptor.Descriptor(
  ...
  full_name='mvsim_msgs.ListTopicsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='topicStartsWith', full_name='mvsim_msgs.ListTopicsRequest.topicStartsWith', index=0,
...
ListTopicsRequest = _reflection.GeneratedProtocolMessageType('ListTopicsRequest', (_message.Message,), dict(
  ...
  __module__ = 'ListTopicsRequest_pb2'
